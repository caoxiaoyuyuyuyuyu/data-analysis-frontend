...
function max(values2, valueof) {
  ...
  if (valueof === void 0) {
    ...
    let index2 = -1;
    for (let value of values2) {
      if ((value = valueof(value, ++index2, values2)) != null && (max3 < value || max3 === void 0 && value >= value)) {
        max3 = value;
      }
    }
  }
...
function min(values2, valueof) {
  ...
  if (valueof === void 0) {
    ...
    let index2 = -1;
    for (let value of values2) {
      if ((value = valueof(value, ++index2, values2)) != null && (min3 > value || min3 === void 0 && value >= value)) {
        min3 = value;
      }
    }
  }
...
function getChildMapping(children2, mapFn) {
  ...
  if (children2)
    import_react2.Children.map(children2, function(c2) {
      return c2;
...
//# sourceMappingURL=chunk-2IMY7DCA.js.map
